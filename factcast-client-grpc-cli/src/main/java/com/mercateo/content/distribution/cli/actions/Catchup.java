...
public class Catchup extends AbstractAction {

    private static final String ACTION_NAME = "catchup";

    private static final String DESCRIPTION = "List all existing facts from FactCast, and exit.";
    ...
    protected void performAction() throws Exception {
        ...
        System.out.println("Listing existing facts:");
        System.out.println();
